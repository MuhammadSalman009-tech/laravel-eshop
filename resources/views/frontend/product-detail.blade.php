                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{ route('product.detail', $p_product->slug) }}"
                                            title="{{$p_product->name}}">
                                            <figure><img src="{{asset('assets/images/products')}}/{{$p_product->image}}" alt="">
                                            </figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <a href="{{ route('product.detail', $p_product->slug) }}" class="product-name"><span>{{$p_product->name}}</span></a>
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{ route('product.detail', $r_product->slug) }}" title="{{$r_product->name}}">
                                    ...
                                    <div class="wrap-btn">
                                        <a href="{{ route('product.detail', $r_product->slug) }}" class="function-link">quick view</a>
                                    </div>
                                </div>
                                <div class="product-info">
                                    <a href="{{ route('product.detail', $r_product->slug) }}" class="product-name"><span>{{$r_product->name}}</span></a>
